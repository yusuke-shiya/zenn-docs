...
OpenRouterの残高不足で失敗しました...
![](/images/Cline/Cline_api_request_failed.png)

[課金ページ](https://openrouter.ai/credits)を開きとりあえず、$10入れました。
...
### Plan / Actのモード切り替え
わかりやすいですね。今回のような新規実装であれば、要件定義以降の詳細設計はClineのPlanで対話しながら進めていくのが良さそうです。  
既存機能の改修であれば、いきなりPlanで対話を開始しても問題ないでしょう。  

## ここは気になるよCline
不要なディレクトリを作っている、テストやstory bookの作成をしていない
つまり見落とされるコンテキストがあるということ
